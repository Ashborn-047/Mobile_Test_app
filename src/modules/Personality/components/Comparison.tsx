...
export const Comparison = ({ results, profile1Emoji, profile2Emoji }: ComparisonProps) => {
  ...
  return (
    <Card className="mb-6">
      <h2 className="text-2xl font-semibold mb-4 text-turquoise text-center">Profile Comparison</h2>
      <div className="grid grid-cols-3 gap-4 text-center mb-4 border-b border-turquoise/20 pb-2">
        ...
        <p className="text-turquoise/70 text-sm flex items-center justify-center gap-2">Before {profile1Emoji}</p>
        <p className="text-turquoise/70 text-sm flex items-center justify-center gap-2">After {profile2Emoji}</p>
      </div>
