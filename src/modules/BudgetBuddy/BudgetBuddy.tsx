...
export const BudgetBuddy = () => {
  ...
  const totalMonth = thisMonthExpenses.reduce(
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      >
        <div className="bg-gradient-to-r from-teal-light to-turquoise/70 rounded-2xl border border-turquoise/30 px-6 py-7 text-center shadow-[0_0_30px_rgba(9,218,198,0.08)]">
          ...
          <p className="mt-2 text-[16px] text-teal-dark/80">
            Track and categorize your expenses intelligently
          </p>
        </div>
      </motion.div>
      ...
      >
        ...
        <select
          ...
          className="rounded-lg px-2 bg-teal-light/70 text-teal-dark border border-turquoise/40"
        >
        ...
        <Card className="mb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div>
              ...
              <p className="text-turquoise text-2xl font-bold">
                {currencySymbol}
      ...
      >
        <motion.div variants={itemVariants}>
          <Card>
            <h2 className="text-xl font-semibold mb-4 text-turquoise">
              Add Expense
            </h2>
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xl font-semibold text-turquoise">
                  {maxCategory || "N/A"}
                </p>
              </div>
